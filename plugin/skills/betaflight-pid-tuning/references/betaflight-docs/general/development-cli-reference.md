...
- `betaflight-4.5-cli-commands.md` — Betaflight 4.5 parameter dump (for reference only)
...
*This reference covers all tuning-relevant variables. For system/hardware configuration variables outside the flight tuning scope (e.g. board-specific resource mappings, I2C speeds, etc.), use `get <varname>` in the CLI or refer to `betaflight-2025.12-cli-commands.md` for the complete enumeration.*
