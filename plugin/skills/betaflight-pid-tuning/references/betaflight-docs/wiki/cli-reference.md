...
| `blackbox_sample_rate`        | 1/4      | 1/1, 1/2, 1/4, 1/8, 1/16       | Fraction of PID loop iterations logged. With the default `pid_process_denom = 1` (PID rate = gyro rate), at 8kHz: `1/8` → 1kHz, `1/4` → 2kHz. Finer rates = larger logs. |
